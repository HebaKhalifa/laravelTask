    ...
    <main class="container-fluid">
        <div class="col-md-8 mx-auto my-5 bg-light p-5 border border-3 shadow shadow-lg">
            <form action="{{ url('users/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div>
                        <input type="hidden" value="put" name="mathod">
                        <div class="row my-3">
                        ...
                        <div class="row my-3">
                            <div class="col-md-3 col-12"><label for="nationalID" class="form-label">Nationa ID</label>
                            </div>
                            <div class="col-md-8 col-12">
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-8 col-12">
                                <textarea name="about_user" class="form-control">{{ $user->about_user }}</textarea>
                                @error('about_user')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
